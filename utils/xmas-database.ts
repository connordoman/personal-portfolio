...
export const XMAS_DB_CONFIG: mysql.PoolOptions = {
    host: process.env.MYSQL_HOST,
    user: process.env.XMAS_USER,
    password: process.env.XMAS_PASSWORD,
    database: process.env.XMAS_DATABASE,
    waitForConnections: true,
    connectionLimit: 10,
    queueLimit: 0,
};
